...

{
    label: "腐化重击",
    tags: ["attack", "enemy"],
    status: { cost: 1, damage: 12 },
    describe: ["造成", { key: ["status", "damage"] }, "点伤害"],
    key: "boss1_card_amalgam_strike",
    interaction: {
        use: {
            target: { faction: "opponent" },
            effects: [{ key: "damage", params: { value: 12 } }]
        }
    }
},
...

{
    ...
    status: { cost: 1 },
    describe: ["对目标施加4层中毒"],
    key: "boss2_card_spore_release",
    interaction: {
        use: {
            target: { faction: "opponent" },
            effects: [{ key: "applyState", params: { stateKey: "poison", stacks: 4 } }]
        }
    }
},
...

{
    label: "钢铁重压",
    tags: ["attack", "enemy"],
    status: { cost: 2, damage: 18 },
    describe: ["造成", { key: ["status", "damage"] }, "点伤害"],
    key: "boss3_card_heavy_crush",
    interaction: {
        use: {
            target: { faction: "opponent" },
            effects: [{ key: "damage", params: { value: 18 } }]
        }
    }
},

{
    ...
    tags: ["attack", "enemy"],
    status: { cost: 1 },
    describe: ["造成8+护甲/4点伤害"],
    key: "boss3_card_armor_slam",
    interaction: {
        use: {
            target: { faction: "opponent" },
            effects: [{ key: "boss_armorScaleDamage", params: { base: 8, armorDivisor: 4 } }]
        }
    }
}]
