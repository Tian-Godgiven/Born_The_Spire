...
export const organList:OrganMap[] = [
    ...
    {
        label:"污染源",
        key:"enemy_organ_pollution_source",
            ...
            possess:{
                ...
                triggers: [{
                    ...
                    event: [{
                        ...
                        sourceType: "eventSource",  // useCard 的 source（player）
                        targetType: "triggerSource",  // 污染源器官（计数器所在位置）
                        ...
                        effect: [{
                            ...
                            params: {
                                ...
                                onTrigger: {
                                    key: "add-wound",
                                    target: "source",  // 映射到 event.source（player）
                                    effectUnits: [{
                                        key: "addCardToHand",
