...
// 金属化核心：持有时获得金属化状态（每回合结束+3护甲），提供护甲冲撞
{
    ...
    describe: ["每回合结束时获得3", {$:"护甲"}, "提供1张", {"@": 0}, "卡牌"],
    rarity: OrganRarity.Uncommon,
    part: OrganPartEnum.Core,
    status: { "max-mass": 40 },
    current: ["mass"],
...
// 腐化腺：战斗开始失去X生命；每回合开始+1层力量
{
    ...
    describe: ["战斗开始失去8点生命", "每回合开始获得1层", {$:"力量"}],
    rarity: OrganRarity.Uncommon,
    part: OrganPartEnum.Gland,
    status: { "max-mass": 40 },
    current: ["mass"],
...
// 污秽厚皮：每回合开始获得X层变硬（受到攻击时减少本次伤害）
{
    ...
    describe: ["每回合开始获得5层", {$:"变硬"}, "受到攻击时减少本次伤害（层数×10%）"],
    rarity: OrganRarity.Common,
    part: OrganPartEnum.Skin,
    status: { "max-mass": 35 },
    current: ["mass"],
...
// 毒素核心：每回合给双方施加1层中毒；提供腐蚀爆发
{
    ...
    describe: ["提供1张", {"@": 0}, "卡牌", "每回合给双方施加1层", {$:"中毒"}],
    rarity: OrganRarity.Common,
    part: OrganPartEnum.Core,
    status: { "max-mass": 35 },
    current: ["mass"],
...
// 点火核：提供重铸卡牌；持有者每打出一张攻击牌获得1层点火
{
    ...
    describe: ["提供重铸卡牌；每打出一张攻击牌，自身获得1层", {$:"点火"}],
    rarity: OrganRarity.Rare,
    part: OrganPartEnum.Core,
    status: { "max-mass": 50 },
    current: ["mass"],
...
// 熔渣心：提供熔铸打击/高炉护壁；获得力量时额外+1
{
    ...
    describe: ["提供熔铸打击与高炉护壁；获得", {$:"力量"}, "时额外+1层"],
    rarity: OrganRarity.Common,
    part: OrganPartEnum.Heart,
    status: { "max-mass": 30 },
    current: ["mass"],
...
// 铁壁核心：提供装甲组装卡牌；战斗开始时+15甲
{
    ...
    describe: ["提供装甲组装卡牌；战斗开始时获得15点", {$:"护甲"}],
    rarity: OrganRarity.Uncommon,
    part: OrganPartEnum.Core,
    status: { "max-mass": 40 },
    current: ["mass"],
...
// 过载核心：提供过载屏障卡牌；战斗开始时+1层力场护盾
{
    ...
    describe: ["提供过载屏障卡牌；战斗开始时获得1层", {$:"力场护盾"}],
    rarity: OrganRarity.Rare,
    part: OrganPartEnum.Heart,
    status: { "max-mass": 40 },
    current: ["mass"],
